...
#' \item \emph{ @returnType } \link{VaultConfigurationSummaryRoot} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | Expected response, returns a dictionary of Vault configurations.
#'
#' \item return type : VaultConfigurationSummaryRoot 
#' \item response headers :
#'
#' \tabular{ll}{
#' X-DataDirect-Request-Key \tab FactSet&#39;s request key header. \cr
...
ConfigurationsApi <- R6::R6Class(
  ...
  public = list(
    ...
    GetVaultConfigurationByIdWithHttpInfo = function(id, ...){
      ...
      urlPath <- "/analytics/engines/vault/v3/configurations/{id}"
      if (!missing(`id`)) {
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "VaultConfigurationRoot", loadNamespace("factset.analyticsapi.engines")),
          error = function(e){
    ...
    GetVaultConfigurationsWithHttpInfo = function(account, ...){
      ...
      urlPath <- "/analytics/engines/vault/v3/configurations"
      # HTTP basic auth
      headerParams['Authorization'] <- paste("Basic", base64enc::base64encode(charToRaw(paste(self$apiClient$username, self$apiClient$password, sep=":"))))
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "VaultConfigurationSummaryRoot", loadNamespace("factset.analyticsapi.engines")),
          error = function(e){
             rlang::abort(message = "Failed to deserialize response", .subclass = "ApiException", ApiException = ApiException$new(http_response = resp))
          }
        )
