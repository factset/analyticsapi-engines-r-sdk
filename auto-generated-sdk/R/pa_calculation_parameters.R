...
PACalculationParameters <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`componentid`, `accounts`=NULL, `benchmarks`=NULL, `dates`=NULL, `groups`=NULL, `currencyisocode`=NULL, `columns`=NULL, `componentdetail`=NULL, ...){
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`componentdetail`)) {
        PACalculationParametersObject[['componentdetail']] <-
    ...
    fromJSON = function(PACalculationParametersJson) {
      ...
      if (!is.null(PACalculationParametersObject$`componentdetail`)) {
        self$`componentdetail` <- PACalculationParametersObject$`componentdetail`
      }
    },
