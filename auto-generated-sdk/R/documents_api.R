...
#' }
#'
#' \strong{ GetPubDocuments } \emph{ Gets Publisher documents and sub-directories in a directory }
...
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | Expected response, returns a list of Publisher documents and directories
#'
#' \item return type : DocumentDirectoriesRoot 
#' \item response headers :
#'
...
DocumentsApi <- R6::R6Class(
  ...
  public = list(
    ...
    GetPA3DocumentsWithHttpInfo = function(path, ...){
      ...
      urlPath <- "/analytics/engines/pa/v3/documents/{path}"
      if (!missing(`path`)) {
    ...
    GetPubDocuments = function(path, ...){
      apiResponse <- self$GetPubDocumentsWithHttpInfo(path, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    GetPubDocumentsWithHttpInfo = function(path, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
      ...
      urlPath <- "/analytics/engines/pub/v3/documents/{path}"
      if (!missing(`path`)) {
        urlPath <- gsub(paste0("\\{", "path", "\\}"), URLencode(as.character(`path`), reserved = TRUE), urlPath)
      }
    ...
    GetSPAR3DocumentsWithHttpInfo = function(path, ...){
      ...
      urlPath <- "/analytics/engines/spar/v3/documents/{path}"
      if (!missing(`path`)) {
        urlPath <- gsub(paste0("\\{", "path", "\\}"), URLencode(as.character(`path`), reserved = TRUE), urlPath)
      }
    ...
    GetVaultDocumentsWithHttpInfo = function(path, ...){
      ...
      urlPath <- "/analytics/engines/vault/v3/documents/{path}"
      if (!missing(`path`)) {
        urlPath <- gsub(paste0("\\{", "path", "\\}"), URLencode(as.character(`path`), reserved = TRUE), urlPath)
      }
