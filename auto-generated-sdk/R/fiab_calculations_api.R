...
#' @section Methods:
#' \describe{
#' \strong{ GetFIABCalculationById } \emph{ Get FIAB calculation by id }
...
#' }
#'
#' \strong{ GetFIABCalculationStatusSummaries } \emph{ Get all FIAB calculation summaries }
...
#' }
#'
#' \strong{ RunFIABCalculation } \emph{ Run FIAB calculation }
...
FIABCalculationsApi <- R6::R6Class(
  ...
  public = list(
    ...
    GetFIABCalculationById = function(id, ...){
      apiResponse <- self$GetFIABCalculationByIdWithHttpInfo(id, ...)
    ...
    GetFIABCalculationByIdWithHttpInfo = function(id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
    ...
    GetFIABCalculationStatusSummaries = function(...){
      apiResponse <- self$GetFIABCalculationStatusSummariesWithHttpInfo(...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    GetFIABCalculationStatusSummariesWithHttpInfo = function(...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
    ...
    RunFIABCalculation = function(fiab.calculation.parameters=NULL, ...){
      apiResponse <- self$RunFIABCalculationWithHttpInfo(fiab.calculation.parameters, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    RunFIABCalculationWithHttpInfo = function(fiab.calculation.parameters=NULL, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
