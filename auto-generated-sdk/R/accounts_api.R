...
AccountsApi <- R6::R6Class(
  ...
  public = list(
    ...
    GetAccountsWithHttpInfo = function(path, ...){
      ...
      urlPath <- "/analytics/lookups/v3/accounts/{path}"
      if (!missing(`path`)) {
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "AccountDirectoriesRoot", loadNamespace("factset.analyticsapi.engines")),
          error = function(e){
