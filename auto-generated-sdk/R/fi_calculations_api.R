...
#' @section Methods:
#' \describe{
#' \strong{ CancelFICalculationById } \emph{ Cancel FI calculation by id }
...
#' }
#'
#' \strong{ GetFICalculationById } \emph{ Get FI calculation by id }
...
#' }
#'
#' \strong{ RunFICalculation } \emph{ Run FI calculation }
...
#' \item \emph{ @param } fi.calculation.parameters \link{FICalculationParameters}
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
...
#' var.fi.calculation.parameters <- FICalculationParameters$new() # FICalculationParameters | 
#'
#' #Run FI calculation
#' api.instance <- FICalculationsApi$new()
#'
...
FICalculationsApi <- R6::R6Class(
  ...
  public = list(
    ...
    CancelFICalculationById = function(id, ...){
      apiResponse <- self$CancelFICalculationByIdWithHttpInfo(id, ...)
    ...
    CancelFICalculationByIdWithHttpInfo = function(id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
      ...
      urlPath <- "/analytics/engines/fi/v1/calculations/{id}"
      if (!missing(`id`)) {
    ...
    GetFICalculationById = function(id, ...){
      apiResponse <- self$GetFICalculationByIdWithHttpInfo(id, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    GetFICalculationByIdWithHttpInfo = function(id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
    ...
    RunFICalculation = function(x.factset.content.organization=NULL, x.factset.content.type=NULL, fi.calculation.parameters=NULL, ...){
      apiResponse <- self$RunFICalculationWithHttpInfo(x.factset.content.organization, x.factset.content.type, fi.calculation.parameters, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    RunFICalculationWithHttpInfo = function(x.factset.content.organization=NULL, x.factset.content.type=NULL, fi.calculation.parameters=NULL, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
      ...
      if (!missing(`fi.calculation.parameters`)) {
        body <- `fi.calculation.parameters`$toJSONString()
      } else {
        body <- NULL
      }

      urlPath <- "/analytics/engines/fi/v1/calculations"
      # HTTP basic auth
      headerParams['Authorization'] <- paste("Basic", base64enc::base64encode(charToRaw(paste(self$apiClient$username, self$apiClient$password, sep=":"))))
