...
FICalculationsApi <- R6::R6Class(
  ...
  public = list(
    ...
    RunFICalculation = function(fi.calculation.parameters=NULL, ...){
      apiResponse <- self$RunFICalculationWithHttpInfo(fi.calculation.parameters, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    RunFICalculationWithHttpInfo = function(fi.calculation.parameters=NULL, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
