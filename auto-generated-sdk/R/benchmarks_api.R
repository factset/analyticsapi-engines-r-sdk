...
#' @description factset.analyticsapi.engines.Benchmarks
...
BenchmarksApi <- R6::R6Class(
  ...
  public = list(
    ...
    GetSPARBenchmarkByIdWithHttpInfo = function(id, ...){
      ...
      urlPath <- "/analytics/engines/spar/v3/benchmarks"
      # HTTP basic auth
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "SPARBenchmarkRoot", loadNamespace("factset.analyticsapi.engines")),
          error = function(e){
