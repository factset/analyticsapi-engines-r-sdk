...
VaultCalculationsApi <- R6::R6Class(
  ...
  public = list(
    ...
    RunVaultCalculation = function(x.factset.content.organization=NULL, x.factset.content.type=NULL, vault.calculation.parameters=NULL, ...){
      apiResponse <- self$RunVaultCalculationWithHttpInfo(x.factset.content.organization, x.factset.content.type, vault.calculation.parameters, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    RunVaultCalculationWithHttpInfo = function(x.factset.content.organization=NULL, x.factset.content.type=NULL, vault.calculation.parameters=NULL, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
