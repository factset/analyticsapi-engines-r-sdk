...
#' @section Methods:
#' \describe{
#' \strong{ CancelCalculationById } \emph{ Cancel Vault calculation by id }
...
#' }
#'
#' \strong{ GetCalculationParameters } \emph{ Get Vault calculation parameters by id }
#' This is the endpoint that returns the calculation parameters passed for a calculation.
#'
#' \itemize{
#' \item \emph{ @param } id character
#' \item \emph{ @returnType } \link{VaultCalculationParametersRoot} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | Expected response, returns the Vault calculation parameters.
#'
#' \item return type : VaultCalculationParametersRoot 
#' \item response headers :
#'
#' \tabular{ll}{
...
#' }
#'
#' \strong{ GetCalculationStatusById } \emph{ Get Vault calculation status by id }
...
#' }
#'
#' \strong{ GetCalculationUnitResultById } \emph{ Get Vault calculation result by id }
...
#' }
#'
#' \strong{ PostAndCalculate } \emph{ Create and Run Vault calculation }
...
#' \item \emph{ @param } vault.calculation.parameters.root \link{VaultCalculationParametersRoot}
#' \item \emph{ @returnType } \link{CalculationStatusRoot} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
...
#' }
#'
#' \strong{ PutAndCalculate } \emph{ Create or Update Vault calculation and run it. }
...
#' var.vault.calculation.parameters.root <- VaultCalculationParametersRoot$new() # VaultCalculationParametersRoot | Calculation Parameters
#'
...
VaultCalculationsApi <- R6::R6Class(
  ...
  public = list(
    ...
    CancelCalculationByIdWithHttpInfo = function(id, ...){
      ...
      urlPath <- "/analytics/engines/vault/v3/calculations/{id}"
      if (!missing(`id`)) {
    ...
    GetCalculationParametersWithHttpInfo = function(id, ...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "VaultCalculationParametersRoot", loadNamespace("factset.analyticsapi.engines")),
          error = function(e){
    ...
    GetCalculationStatusByIdWithHttpInfo = function(id, ...){
      ...
      urlPath <- "/analytics/engines/vault/v3/calculations/{id}/status"
      if (!missing(`id`)) {
        urlPath <- gsub(paste0("\\{", "id", "\\}"), URLencode(as.character(`id`), reserved = TRUE), urlPath)
      }
    ...
    GetCalculationUnitResultByIdWithHttpInfo = function(id, unit.id, accept=NULL, ...){
      ...
      urlPath <- "/analytics/engines/vault/v3/calculations/{id}/units/{unitId}/result"
      if (!missing(`id`)) {
        urlPath <- gsub(paste0("\\{", "id", "\\}"), URLencode(as.character(`id`), reserved = TRUE), urlPath)
      }
    ...
    PostAndCalculate = function(x.fact.set.api.long.running.deadline=NULL, cache.control=NULL, vault.calculation.parameters.root=NULL, ...){
      apiResponse <- self$PostAndCalculateWithHttpInfo(x.fact.set.api.long.running.deadline, cache.control, vault.calculation.parameters.root, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    PostAndCalculateWithHttpInfo = function(x.fact.set.api.long.running.deadline=NULL, cache.control=NULL, vault.calculation.parameters.root=NULL, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
      ...
      if (!missing(`vault.calculation.parameters.root`)) {
        body <- `vault.calculation.parameters.root`$toJSONString()
      } else {
        body <- NULL
      }

      urlPath <- "/analytics/engines/vault/v3/calculations"
      # HTTP basic auth
      headerParams['Authorization'] <- paste("Basic", base64enc::base64encode(charToRaw(paste(self$apiClient$username, self$apiClient$password, sep=":"))))
    ...
    PutAndCalculate = function(id, x.fact.set.api.long.running.deadline=NULL, cache.control=NULL, vault.calculation.parameters.root=NULL, ...){
      apiResponse <- self$PutAndCalculateWithHttpInfo(id, x.fact.set.api.long.running.deadline, cache.control, vault.calculation.parameters.root, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    PutAndCalculateWithHttpInfo = function(id, x.fact.set.api.long.running.deadline=NULL, cache.control=NULL, vault.calculation.parameters.root=NULL, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
