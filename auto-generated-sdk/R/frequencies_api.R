...
FrequenciesApi <- R6::R6Class(
  ...
  public = list(
    ...
    GetPAFrequenciesWithHttpInfo = function(...){
      ...
      urlPath <- "/analytics/engines/pa/v3/frequencies"
      # HTTP basic auth
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "FrequencyRoot", loadNamespace("factset.analyticsapi.engines")),
          error = function(e){
    ...
    GetSPARFrequenciesWithHttpInfo = function(...){
      ...
      urlPath <- "/analytics/engines/spar/v3/frequencies"
      # HTTP basic auth
      headerParams['Authorization'] <- paste("Basic", base64enc::base64encode(charToRaw(paste(self$apiClient$username, self$apiClient$password, sep=":"))))
    ...
    GetVaultFrequenciesWithHttpInfo = function(...){
      ...
      urlPath <- "/analytics/engines/vault/v3/frequencies"
      # HTTP basic auth
      headerParams['Authorization'] <- paste("Basic", base64enc::base64encode(charToRaw(paste(self$apiClient$username, self$apiClient$password, sep=":"))))
