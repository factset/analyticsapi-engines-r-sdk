...
#' @docType class
#' @title FPOOptimizer operations
#' @description factset.analyticsapi.engines.FPOOptimizer
...
FPOOptimizerApi <- R6::R6Class(
  ...
  public = list(
    ...
    CancelOptimizationByIdWithHttpInfo = function(id, ...){
      ...
      urlPath <- "/analytics/engines/fpo/v3/optimizations/{id}"
      if (!missing(`id`)) {
    ...
    GetOptimizationParametersWithHttpInfo = function(id, ...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "FPOOptimizationParametersRoot", loadNamespace("factset.analyticsapi.engines")),
          error = function(e){
    ...
    GetOptimizationResultWithHttpInfo = function(id, accept=NULL, ...){
      ...
      urlPath <- "/analytics/engines/fpo/v3/optimizations/{id}/result"
      if (!missing(`id`)) {
        urlPath <- gsub(paste0("\\{", "id", "\\}"), URLencode(as.character(`id`), reserved = TRUE), urlPath)
      }
    ...
    GetOptimizationStatusByIdWithHttpInfo = function(id, ...){
      ...
      urlPath <- "/analytics/engines/fpo/v3/optimizations/{id}/status"
      if (!missing(`id`)) {
        urlPath <- gsub(paste0("\\{", "id", "\\}"), URLencode(as.character(`id`), reserved = TRUE), urlPath)
      }
    ...
    PostAndOptimize = function(x.fact.set.api.long.running.deadline=NULL, cache.control=NULL, fpo.optimization.parameters.root=NULL, ...){
      apiResponse <- self$PostAndOptimizeWithHttpInfo(x.fact.set.api.long.running.deadline, cache.control, fpo.optimization.parameters.root, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    PostAndOptimizeWithHttpInfo = function(x.fact.set.api.long.running.deadline=NULL, cache.control=NULL, fpo.optimization.parameters.root=NULL, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
      ...
      if (!missing(`fpo.optimization.parameters.root`)) {
        body <- `fpo.optimization.parameters.root`$toJSONString()
      } else {
        body <- NULL
      }

      urlPath <- "/analytics/engines/fpo/v3/optimizations"
      # HTTP basic auth
      headerParams['Authorization'] <- paste("Basic", base64enc::base64encode(charToRaw(paste(self$apiClient$username, self$apiClient$password, sep=":"))))
    ...
    PutAndOptimize = function(id, x.fact.set.api.long.running.deadline=NULL, cache.control=NULL, fpo.optimization.parameters.root=NULL, ...){
      apiResponse <- self$PutAndOptimizeWithHttpInfo(id, x.fact.set.api.long.running.deadline, cache.control, fpo.optimization.parameters.root, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    PutAndOptimizeWithHttpInfo = function(id, x.fact.set.api.long.running.deadline=NULL, cache.control=NULL, fpo.optimization.parameters.root=NULL, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
