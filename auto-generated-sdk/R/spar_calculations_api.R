...
SPARCalculationsApi <- R6::R6Class(
  ...
  public = list(
    ...
    RunSPARCalculation = function(spar.calculation.parameters=NULL, ...){
      apiResponse <- self$RunSPARCalculationWithHttpInfo(spar.calculation.parameters, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    RunSPARCalculationWithHttpInfo = function(spar.calculation.parameters=NULL, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
