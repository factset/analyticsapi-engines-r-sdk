...
SPARCalculationsApi <- R6::R6Class(
  ...
  public = list(
    ...
    CancelSPARCalculationById = function(id, ...){
      apiResponse <- self$CancelSPARCalculationByIdWithHttpInfo(id, ...)
    ...
    CancelSPARCalculationByIdWithHttpInfo = function(id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
      ...
      urlPath <- "/analytics/engines/spar/v2/calculations/{id}"
      if (!missing(`id`)) {
    ...
    GetSPARCalculationById = function(id, ...){
      apiResponse <- self$GetSPARCalculationByIdWithHttpInfo(id, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    GetSPARCalculationByIdWithHttpInfo = function(id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
    ...
    RunSPARCalculation = function(x.factset.content.organization=NULL, x.factset.content.type=NULL, spar.calculation.parameters=NULL, ...){
      apiResponse <- self$RunSPARCalculationWithHttpInfo(x.factset.content.organization, x.factset.content.type, spar.calculation.parameters, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    RunSPARCalculationWithHttpInfo = function(x.factset.content.organization=NULL, x.factset.content.type=NULL, spar.calculation.parameters=NULL, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
      ...
      if (!missing(`spar.calculation.parameters`)) {
        body <- `spar.calculation.parameters`$toJSONString()
      } else {
        body <- NULL
      }

      urlPath <- "/analytics/engines/spar/v2/calculations"
      # HTTP basic auth
      headerParams['Authorization'] <- paste("Basic", base64enc::base64encode(charToRaw(paste(self$apiClient$username, self$apiClient$password, sep=":"))))
