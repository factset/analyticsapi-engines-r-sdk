...
PACalculationsApi <- R6::R6Class(
  ...
  public = list(
    ...
    RunPACalculation = function(pa.calculation.parameters=NULL, ...){
      apiResponse <- self$RunPACalculationWithHttpInfo(pa.calculation.parameters, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    RunPACalculationWithHttpInfo = function(pa.calculation.parameters=NULL, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
