...
#'
#' @field pub  named list( \link{PubCalculationParameters} ) [optional]
#'
#'
...
Calculation <- R6::R6Class(
  ...
  public = list(
    ...
    `vault` = NULL,
    `pub` = NULL,
    initialize = function(`pa`=NULL, `spar`=NULL, `vault`=NULL, `pub`=NULL, ...){
    ...
    fromJSON = function(CalculationJson) {
      ...
      if (!is.null(CalculationObject$`pub`)) {
        self$`pub` <- ApiClient$new()$deserializeObj(CalculationObject$`pub`, "map(PubCalculationParameters)", loadNamespace("factset.analyticsapi.engines"))
      }
    },
