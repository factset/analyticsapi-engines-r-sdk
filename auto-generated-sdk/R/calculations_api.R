...
CalculationsApi <- R6::R6Class(
  ...
  public = list(
    ...
    RunCalculation = function(x.factset.content.organization=NULL, x.factset.content.type=NULL, calculation=NULL, ...){
      apiResponse <- self$RunCalculationWithHttpInfo(x.factset.content.organization, x.factset.content.type, calculation, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    RunCalculationWithHttpInfo = function(x.factset.content.organization=NULL, x.factset.content.type=NULL, calculation=NULL, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
