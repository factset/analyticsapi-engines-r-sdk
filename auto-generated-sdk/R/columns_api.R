...
#' \item \emph{ @returnType } \link{ColumnSummaryRoot} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | Expected response, returns a list of PA columns
#'
#' \item return type : ColumnSummaryRoot 
#' \item response headers :
#'
#' \tabular{ll}{
#' X-DataDirect-Request-Key \tab FactSet&#39;s request key header. \cr
...
ColumnsApi <- R6::R6Class(
  ...
  public = list(
    ...
    GetPAColumnByIdWithHttpInfo = function(id, ...){
      ...
      urlPath <- "/analytics/engines/pa/v3/columns/{id}"
      if (!missing(`id`)) {
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "ColumnRoot", loadNamespace("factset.analyticsapi.engines")),
          error = function(e){
    ...
    GetPAColumnsWithHttpInfo = function(name='', category='', directory='', ...){
      ...
      urlPath <- "/analytics/engines/pa/v3/columns"
      # HTTP basic auth
      headerParams['Authorization'] <- paste("Basic", base64enc::base64encode(charToRaw(paste(self$apiClient$username, self$apiClient$password, sep=":"))))
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "ColumnSummaryRoot", loadNamespace("factset.analyticsapi.engines")),
          error = function(e){
             rlang::abort(message = "Failed to deserialize response", .subclass = "ApiException", ApiException = ApiException$new(http_response = resp))
          }
        )
