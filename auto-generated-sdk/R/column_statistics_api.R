...
#' @docType class
#' @title ColumnStatistics operations
#' @description factset.analyticsapi.engines.ColumnStatistics
...
ColumnStatisticsApi <- R6::R6Class(
  ...
  public = list(
    ...
    GetPAColumnStatistics = function(...){
      apiResponse <- self$GetPAColumnStatisticsWithHttpInfo(...)
    ...
    GetPAColumnStatisticsWithHttpInfo = function(...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()

      urlPath <- "/analytics/engines/pa/v3/columnstatistics"
      # HTTP basic auth
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "ColumnStatisticRoot", loadNamespace("factset.analyticsapi.engines")),
          error = function(e){
