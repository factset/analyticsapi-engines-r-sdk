...
DatesApi <- R6::R6Class(
  ...
  public = list(
    ...
    ConvertPADatesToAbsoluteFormatWithHttpInfo = function(enddate, componentid, account, startdate=NULL, ...){
      ...
      urlPath <- "/analytics/engines/pa/v3/dates"
      # HTTP basic auth
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "DateParametersSummaryRoot", loadNamespace("factset.analyticsapi.engines")),
          error = function(e){
    ...
    ConvertVaultDatesToAbsoluteFormatWithHttpInfo = function(enddate, componentid, account, startdate=NULL, ...){
      ...
      urlPath <- "/analytics/engines/vault/v3/dates"
      # HTTP basic auth
      headerParams['Authorization'] <- paste("Basic", base64enc::base64encode(charToRaw(paste(self$apiClient$username, self$apiClient$password, sep=":"))))
