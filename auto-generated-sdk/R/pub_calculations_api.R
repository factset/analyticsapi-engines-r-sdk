...
#' @docType class
#' @title PubCalculations operations
#' @description factset.analyticsapi.engines.PubCalculations
#' @format An \code{R6Class} generator object
#' @field apiClient Handles the client-server communication.
#'
#' @section Methods:
#' \describe{
#' \strong{ CancelCalculationById } \emph{ Cancel Pub calculation by id }
...
#' }
#'
#' \strong{ GetCalculationParameters } \emph{ Get Pub calculation parameters by id }
#' This is the endpoint that returns the calculation parameters passed for a calculation.
#'
#' \itemize{
#' \item \emph{ @param } id character
#' \item \emph{ @returnType } \link{PubCalculationParametersRoot} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | Expected response, returns the Pub calculation parameters.
#'
#' \item return type : PubCalculationParametersRoot 
#' \item response headers :
#'
#' \tabular{ll}{
...
#' }
#'
#' \strong{ GetCalculationStatusById } \emph{ Get Pub calculation status by id }
...
#' }
#'
#' \strong{ GetCalculationUnitResultById } \emph{ Get Pub calculation result by id }
...
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
#' \item status code : 200 | Expected response once calculation is completed, returns result in the format specified in the Calculation parameters.
#'
...
#' }
#'
#' \strong{ PostAndCalculate } \emph{ Create and Run Pub calculation }
...
#' \item \emph{ @param } pub.calculation.parameters.root \link{PubCalculationParametersRoot}
#' \item \emph{ @returnType } \link{CalculationStatusRoot} \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
...
#' }
#'
#' \strong{ PutAndCalculate } \emph{ Create or Update Pub calculation and run it. }
...
#' var.pub.calculation.parameters.root <- PubCalculationParametersRoot$new() # PubCalculationParametersRoot | Calculation Parameters
#'
...
PubCalculationsApi <- R6::R6Class(
  ...
  public = list(
    ...
    CancelCalculationByIdWithHttpInfo = function(id, ...){
      ...
      urlPath <- "/analytics/engines/pub/v3/calculations/{id}"
      if (!missing(`id`)) {
    ...
    GetCalculationParametersWithHttpInfo = function(id, ...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "PubCalculationParametersRoot", loadNamespace("factset.analyticsapi.engines")),
          error = function(e){
    ...
    GetCalculationStatusByIdWithHttpInfo = function(id, ...){
      ...
      urlPath <- "/analytics/engines/pub/v3/calculations/{id}/status"
      if (!missing(`id`)) {
        urlPath <- gsub(paste0("\\{", "id", "\\}"), URLencode(as.character(`id`), reserved = TRUE), urlPath)
      }
    ...
    GetCalculationUnitResultByIdWithHttpInfo = function(id, unit.id, accept=NULL, ...){
      ...
      urlPath <- "/analytics/engines/pub/v3/calculations/{id}/units/{unitId}/result"
      if (!missing(`id`)) {
        urlPath <- gsub(paste0("\\{", "id", "\\}"), URLencode(as.character(`id`), reserved = TRUE), urlPath)
      }
    ...
    PostAndCalculate = function(x.fact.set.api.long.running.deadline=NULL, cache.control=NULL, pub.calculation.parameters.root=NULL, ...){
      apiResponse <- self$PostAndCalculateWithHttpInfo(x.fact.set.api.long.running.deadline, cache.control, pub.calculation.parameters.root, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    PostAndCalculateWithHttpInfo = function(x.fact.set.api.long.running.deadline=NULL, cache.control=NULL, pub.calculation.parameters.root=NULL, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
      ...
      if (!missing(`pub.calculation.parameters.root`)) {
        body <- `pub.calculation.parameters.root`$toJSONString()
      } else {
        body <- NULL
      }

      urlPath <- "/analytics/engines/pub/v3/calculations"
      # HTTP basic auth
      headerParams['Authorization'] <- paste("Basic", base64enc::base64encode(charToRaw(paste(self$apiClient$username, self$apiClient$password, sep=":"))))
    ...
    PutAndCalculate = function(id, x.fact.set.api.long.running.deadline=NULL, cache.control=NULL, pub.calculation.parameters.root=NULL, ...){
      apiResponse <- self$PutAndCalculateWithHttpInfo(id, x.fact.set.api.long.running.deadline, cache.control, pub.calculation.parameters.root, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    PutAndCalculateWithHttpInfo = function(id, x.fact.set.api.long.running.deadline=NULL, cache.control=NULL, pub.calculation.parameters.root=NULL, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
