...
StrategyDocumentsApi <- R6::R6Class(
  ...
  public = list(
    ...
    GetAxiomaEquityStrategyDocumentsWithHttpInfo = function(path, ...){
      ...
      urlPath <- "/analytics/engines/axp/v3/strategies/{path}"
      if (!missing(`path`)) {
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "DocumentDirectoriesRoot", loadNamespace("factset.analyticsapi.engines")),
          error = function(e){
    ...
    GetAxiomaFIStrategyDocumentsWithHttpInfo = function(path, ...){
      ...
      urlPath <- "/analytics/engines/afi/v3/strategies/{path}"
      if (!missing(`path`)) {
        urlPath <- gsub(paste0("\\{", "path", "\\}"), URLencode(as.character(`path`), reserved = TRUE), urlPath)
      }
    ...
    GetBarraStrategyDocumentsWithHttpInfo = function(path, ...){
      ...
      urlPath <- "/analytics/engines/bpm/v3/strategies/{path}"
      if (!missing(`path`)) {
        urlPath <- gsub(paste0("\\{", "path", "\\}"), URLencode(as.character(`path`), reserved = TRUE), urlPath)
      }
    ...
    GetFPOStrategyDocumentsWithHttpInfo = function(path, ...){
      ...
      urlPath <- "/analytics/engines/fpo/v3/strategies/{path}"
      if (!missing(`path`)) {
        urlPath <- gsub(paste0("\\{", "path", "\\}"), URLencode(as.character(`path`), reserved = TRUE), urlPath)
      }
    ...
    GetNorthfieldStrategyDocumentsWithHttpInfo = function(path, ...){
      ...
      urlPath <- "/analytics/engines/npo/v3/strategies/{path}"
      if (!missing(`path`)) {
        urlPath <- gsub(paste0("\\{", "path", "\\}"), URLencode(as.character(`path`), reserved = TRUE), urlPath)
      }
