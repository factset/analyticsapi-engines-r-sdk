...
GroupsApi <- R6::R6Class(
  ...
  public = list(
    ...
    GetPAGroupsWithHttpInfo = function(...){
      ...
      urlPath <- "/analytics/engines/pa/v3/groups"
      # HTTP basic auth
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "GroupRoot", loadNamespace("factset.analyticsapi.engines")),
          error = function(e){
