...
# **RunVaultCalculation**
> object RunVaultCalculation(x.factset.content.organization=var.x.factset.content.organization, x.factset.content.type=var.x.factset.content.type, vault.calculation.parameters=var.vault.calculation.parameters)
...
api.instance$apiClient$password <- 'TODO_YOUR_PASSWORD';
result <- tryCatch(
             api.instance$RunVaultCalculation(x.factset.content.organization=var.x.factset.content.organization, x.factset.content.type=var.x.factset.content.type, vault.calculation.parameters=var.vault.calculation.parameters),
             ApiException = function(ex) ex 
          )
# In case of error, print the error object 
if(!is.null(result$ApiException)) {
