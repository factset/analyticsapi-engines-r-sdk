...
------------- | ------------- | ------------- | -------------
 **id** | **character**| from url, provided from the location header in the Create and Run PA calculation endpoint | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **character**| from url, provided from the location header in the Get PA calculation status by id endpoint | 
 **unit.id** | **character**| from url, provided from the location header in the Get PA calculation status by id endpoint | 
...
# **PostAndCalculate**
> CalculationStatusRoot PostAndCalculate(x.fact.set.api.long.running.deadline=var.x.fact.set.api.long.running.deadline, cache.control=var.cache.control, pa.calculation.parameters.root=var.pa.calculation.parameters.root)
...
var.pa.calculation.parameters.root <- PACalculationParametersRoot$new(TODO, CalculationMeta$new("contentorganization_example", "contenttype_example")) # PACalculationParametersRoot | Calculation Parameters
 ...
 **pa.calculation.parameters.root** | [**PACalculationParametersRoot**](PACalculationParametersRoot.md)| Calculation Parameters | [optional] 
...
# **PutAndCalculate**
> CalculationStatusRoot PutAndCalculate(id, x.fact.set.api.long.running.deadline=var.x.fact.set.api.long.running.deadline, cache.control=var.cache.control, pa.calculation.parameters.root=var.pa.calculation.parameters.root)
