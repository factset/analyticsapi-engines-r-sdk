# R API client for factset.analyticsapi.engines.v2
...
cd GIT_REPO_ID
R CMD build .
R CMD check factset.analyticsapi.engines.v2_2.0.0.tar.gz
R CMD INSTALL factset.analyticsapi.engines.v2_2.0.0.tar.gz
```

### Install the package

```R
install.packages("factset.analyticsapi.engines.v2")
```
