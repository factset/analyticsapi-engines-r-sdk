...
#' @description factset.analyticsapi.engines.v2.Frequencies
...
#'
#' \itemize{
#' \item \emph{ @returnType } \link[factset.analyticsapi.engines.v2:Frequency]{ named list(Frequency) }   \cr
#'
    ...
    GetPAFrequenciesWithHttpInfo = function(...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "map(Frequency)", "package:factset.analyticsapi.engines.v2"),
          error = function(e){
