...
#' @description factset.analyticsapi.engines.v2.Columns
...
#' \item \emph{ @returnType } \link[factset.analyticsapi.engines.v2:Column]{ Column }   \cr
#'
...
#' \item \emph{ @returnType } \link[factset.analyticsapi.engines.v2:ColumnSummary]{ named list(ColumnSummary) }   \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
...
ColumnsApi <- R6::R6Class(
  ...
  public = list(
    ...
    GetPAColumnByIdWithHttpInfo = function(id, ...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "Column", "package:factset.analyticsapi.engines.v2"),
          error = function(e){
    ...
    GetPAColumnsWithHttpInfo = function(name=NULL, category=NULL, directory=NULL, ...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "map(ColumnSummary)", "package:factset.analyticsapi.engines.v2"),
          error = function(e){
             rlang::abort(message = "Failed to deserialize response", .subclass = "ApiException", ApiException = ApiException$new(http_response = resp))
          }
        )
