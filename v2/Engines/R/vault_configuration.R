...
#'
#' @field accounts   \link[factset.analyticsapi.engines.v2:ConfigurationAccount]{   named list(ConfigurationAccount)   }  [optional]
#'
#'
  ...
  public = list(
    ...
    fromJSON = function(VaultConfigurationJson) {
      ...
      if (!is.null(VaultConfigurationObject$`accounts`)) {
        self$`accounts` <- ApiClient$new()$deserializeObj(VaultConfigurationObject$`accounts`, "map(ConfigurationAccount)", "package:factset.analyticsapi.engines.v2")
      }
    },
