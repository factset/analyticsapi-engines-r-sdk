...
#' @description factset.analyticsapi.engines.v2.Configurations
...
#' \item \emph{ @returnType } \link[factset.analyticsapi.engines.v2:VaultConfiguration]{ VaultConfiguration }   \cr
#'
...
#' \item \emph{ @returnType } \link[factset.analyticsapi.engines.v2:VaultConfigurationSummary]{ named list(VaultConfigurationSummary) }   \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
...
ConfigurationsApi <- R6::R6Class(
  ...
  public = list(
    ...
    GetVaultConfigurationByIdWithHttpInfo = function(id, ...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "VaultConfiguration", "package:factset.analyticsapi.engines.v2"),
          error = function(e){
    ...
    GetVaultConfigurationsWithHttpInfo = function(account, ...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "map(VaultConfigurationSummary)", "package:factset.analyticsapi.engines.v2"),
          error = function(e){
             rlang::abort(message = "Failed to deserialize response", .subclass = "ApiException", ApiException = ApiException$new(http_response = resp))
          }
        )
