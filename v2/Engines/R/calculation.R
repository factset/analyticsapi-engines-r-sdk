...
#' @field pa   \link[factset.analyticsapi.engines.v2:PACalculationParameters]{   named list(PACalculationParameters)   }  [optional]
#'
#' @field spar   \link[factset.analyticsapi.engines.v2:SPARCalculationParameters]{   named list(SPARCalculationParameters)   }  [optional]
#'
#' @field vault   \link[factset.analyticsapi.engines.v2:VaultCalculationParameters]{   named list(VaultCalculationParameters)   }  [optional]
#'
#'
  ...
  public = list(
    ...
    fromJSON = function(CalculationJson) {
      ...
      if (!is.null(CalculationObject$`pa`)) {
        self$`pa` <- ApiClient$new()$deserializeObj(CalculationObject$`pa`, "map(PACalculationParameters)", "package:factset.analyticsapi.engines.v2")
      }
      if (!is.null(CalculationObject$`spar`)) {
        self$`spar` <- ApiClient$new()$deserializeObj(CalculationObject$`spar`, "map(SPARCalculationParameters)", "package:factset.analyticsapi.engines.v2")
      }
      if (!is.null(CalculationObject$`vault`)) {
        self$`vault` <- ApiClient$new()$deserializeObj(CalculationObject$`vault`, "map(VaultCalculationParameters)", "package:factset.analyticsapi.engines.v2")
      }
    },
