...
#' @description factset.analyticsapi.engines.v2.Currencies
...
#'
#' \itemize{
#' \item \emph{ @returnType } \link[factset.analyticsapi.engines.v2:Currency]{ named list(Currency) }   \cr
#'
    ...
    GetPACurrenciesWithHttpInfo = function(...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "map(Currency)", "package:factset.analyticsapi.engines.v2"),
          error = function(e){
