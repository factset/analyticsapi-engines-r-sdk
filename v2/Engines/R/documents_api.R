...
#' @description factset.analyticsapi.engines.v2.Documents
...
#' \item \emph{ @returnType } \link[factset.analyticsapi.engines.v2:DocumentDirectories]{ DocumentDirectories }   \cr
#'
    ...
    GetPA3DocumentsWithHttpInfo = function(path, ...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "DocumentDirectories", "package:factset.analyticsapi.engines.v2"),
          error = function(e){
