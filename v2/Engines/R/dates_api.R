...
#' @description factset.analyticsapi.engines.v2.Dates
...
#' \item \emph{ @returnType } \link[factset.analyticsapi.engines.v2:DateParametersSummary]{ DateParametersSummary }   \cr
#'
    ...
    ConvertPADatesToAbsoluteFormatWithHttpInfo = function(enddate, componentid, account, startdate=NULL, ...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "DateParametersSummary", "package:factset.analyticsapi.engines.v2"),
          error = function(e){
