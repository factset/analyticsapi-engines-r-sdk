...
#' @description factset.analyticsapi.engines.v2.Accounts
...
#' \item \emph{ @returnType } \link[factset.analyticsapi.engines.v2:AccountDirectories]{ AccountDirectories }   \cr
#'
    ...
    GetAccountsWithHttpInfo = function(path, ...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "AccountDirectories", "package:factset.analyticsapi.engines.v2"),
          error = function(e){
