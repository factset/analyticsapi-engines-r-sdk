...
#'
#' @field accounts   \link[factset.analyticsapi.engines.v2:SPARIdentifier]{   list(SPARIdentifier)   }  [optional]
#'
#' @field benchmark   \link[factset.analyticsapi.engines.v2:SPARIdentifier]{  SPARIdentifier  }  [optional]
#'
#' @field dates   \link[factset.analyticsapi.engines.v2:SPARDateParameters]{  SPARDateParameters  }  [optional]
#'
#'
  ...
  public = list(
    ...
    fromJSON = function(SPARCalculationParametersJson) {
      ...
      if (!is.null(SPARCalculationParametersObject$`accounts`)) {
        self$`accounts` <- ApiClient$new()$deserializeObj(SPARCalculationParametersObject$`accounts`, "array[SPARIdentifier]", "package:factset.analyticsapi.engines.v2")
      }
