  ...
  public = list(
    ...
    fromJSON = function(DocumentDirectoriesJson) {
      ...
      if (!is.null(DocumentDirectoriesObject$`documents`)) {
        self$`documents` <- ApiClient$new()$deserializeObj(DocumentDirectoriesObject$`documents`, "array[character]", "package:factset.analyticsapi.engines.v2")
      }
      if (!is.null(DocumentDirectoriesObject$`directories`)) {
        self$`directories` <- ApiClient$new()$deserializeObj(DocumentDirectoriesObject$`directories`, "array[character]", "package:factset.analyticsapi.engines.v2")
      }
    },
