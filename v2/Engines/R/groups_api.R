...
#' @description factset.analyticsapi.engines.v2.Groups
...
#'
#' \itemize{
#' \item \emph{ @returnType } \link[factset.analyticsapi.engines.v2:Group]{ named list(Group) }   \cr
#'
    ...
    GetPAGroupsWithHttpInfo = function(...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "map(Group)", "package:factset.analyticsapi.engines.v2"),
          error = function(e){
