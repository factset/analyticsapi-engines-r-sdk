...
#'
#' @field account   \link[factset.analyticsapi.engines.v2:VaultIdentifier]{  VaultIdentifier  }  [optional]
#'
#' @field benchmark   \link[factset.analyticsapi.engines.v2:VaultIdentifier]{  VaultIdentifier  }  [optional]
#'
#' @field currencyisocode   character  [optional]
#'
#' @field dates   \link[factset.analyticsapi.engines.v2:VaultDateParameters]{  VaultDateParameters  }  [optional]
#'
