...
#'
#' @field pa   \link[factset.analyticsapi.engines.v2:CalculationUnitStatus]{   named list(CalculationUnitStatus)   }  [optional]
#'
#' @field spar   \link[factset.analyticsapi.engines.v2:CalculationUnitStatus]{   named list(CalculationUnitStatus)   }  [optional]
#'
#' @field vault   \link[factset.analyticsapi.engines.v2:CalculationUnitStatus]{   named list(CalculationUnitStatus)   }  [optional]
#'
#'
  ...
  public = list(
    ...
    fromJSON = function(CalculationStatusJson) {
      ...
      if (!is.null(CalculationStatusObject$`pa`)) {
        self$`pa` <- ApiClient$new()$deserializeObj(CalculationStatusObject$`pa`, "map(CalculationUnitStatus)", "package:factset.analyticsapi.engines.v2")
      }
      if (!is.null(CalculationStatusObject$`spar`)) {
        self$`spar` <- ApiClient$new()$deserializeObj(CalculationStatusObject$`spar`, "map(CalculationUnitStatus)", "package:factset.analyticsapi.engines.v2")
      }
      if (!is.null(CalculationStatusObject$`vault`)) {
        self$`vault` <- ApiClient$new()$deserializeObj(CalculationStatusObject$`vault`, "map(CalculationUnitStatus)", "package:factset.analyticsapi.engines.v2")
      }
    },
