...
#' @description factset.analyticsapi.engines.v2.Calculations
...
#' \itemize{
#' \item \emph{ @param } id character
#' \item \emph{ @returnType } \link[factset.analyticsapi.engines.v2:CalculationStatus]{ CalculationStatus }   \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
...
#'
#' \itemize{
#' \item \emph{ @returnType } \link[factset.analyticsapi.engines.v2:CalculationStatusSummary]{ named list(CalculationStatusSummary) }   \cr
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
...
#'
#' \itemize{
#' \item \emph{ @param } calculation \link[factset.analyticsapi.engines.v2:Calculation]{ Calculation }
#'
#' \item On encountering errors, an error of subclass ApiException will be thrown.
#'
...
CalculationsApi <- R6::R6Class(
  ...
  public = list(
    ...
    GetCalculationStatusByIdWithHttpInfo = function(id, ...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "CalculationStatus", "package:factset.analyticsapi.engines.v2"),
          error = function(e){
    ...
    GetCalculationStatusSummariesWithHttpInfo = function(...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "map(CalculationStatusSummary)", "package:factset.analyticsapi.engines.v2"),
          error = function(e){
             rlang::abort(message = "Failed to deserialize response", .subclass = "ApiException", ApiException = ApiException$new(http_response = resp))
          }
        )
