...
#' @description factset.analyticsapi.engines.v2.ColumnStatistics
...
#'
#' \itemize{
#' \item \emph{ @returnType } \link[factset.analyticsapi.engines.v2:ColumnStatistic]{ named list(ColumnStatistic) }   \cr
#'
    ...
    GetPAColumnStatisticsWithHttpInfo = function(...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "map(ColumnStatistic)", "package:factset.analyticsapi.engines.v2"),
          error = function(e){
